        ...
        <section id="outro">
            ...
            <div id="outro_credits">
                ...
                <div class="text"> 
                    ...
                    <h3 v-if="isEnglish">References</h3>
                    <h3 v-else>Literaturverzeichnis</h3>
...
export default {
    ...
    data() {
        return {
            ...
            //scrollingText:{
            network_intro: {
                step0:{id:0,eng:"This is the simplest possible mobility, as it only consists of one mode of mobility: Walking.",de:"Das ist die einfachste Form der Mobilität, da sie nur aus einer einzigen Fortbewegungsart besteht: Gehen."},
                ...
                step7:{id:7,eng:"This close link will get more interesting later when we see how public transportation and individual supporting mobility accounts for a flexible model of mobility that allows being spontaneous.",de:"Diese enge Verbindung wird später noch interessanter, wenn wir sehen, wie öffentliche Verkehrsmittel und individuell unterstützende Mobilität ein flexibles Mobilitätsmodell darstellen, das Spontanität zulässt."}
            },
            network_person1: {
                step8:{id:8,eng:"This is the first graph representing the mobility of one of the participants during the lockdown of march 2021. We can't see how the participant's mobility was before the pandemic, but we can clearly identify a focus on individual car-centric mobility.",de:"Das ist das erste Diagramm, das die Mobilität einer Studienteilnehmer:in während des Lockdowns im März 2021 darstellt. Wir können nicht sehen, wie die Mobilität der Person vor der Pandemie war, aber wir können eindeutig einen Schwerpunkt auf der individuellen Mobilität mit dem Auto erkennen."},
            ...
            network_person2:{
                ...
                step19:{id:19,eng:"...pick someone up, maybe their kid. For this participant, the reason for using the bicycle is mainly the shorter travel time. This contrasts common beliefs, that this mobility is more time-consuming because it could depend on fixed schedules of trains or the physical place you locked your Bicycle.",de:" ... holt jemanden ab, vielleicht ein Kind. Für diese Person nutzt das Fahrrads vor allem wegen der kürzeren Fahrzeit. Dies steht im Gegensatz zu der allgemeinen Meinung, dass diese Art der Mobilität zeitaufwändiger sei, da sie von festen Fahrplänen der Züge oder dem Ort, an dem man sein Fahrrad abschließt, abhängen würde."},
            ...
            network_person3:{
                step21:{id:21,eng:"The next participant has a diverse mobility and uses all modes of transport for different occasions.",de:"Die nächste Person hat eine sehr gemischte Mobilität und verwendet alle Verkehrsmittel zu unterschiedlichen Anlässen."},
                ...
                step23:{id:23,eng:"Oftentimes, the persons combines the car ride to work with other errands. For example, they bring their kid to kindergarden or get groceries.",de:"Oft wird die Autofahrt zur Arbeit mit weiteren Orten kombiniert. Beispielsweise wird das Kind zur Kita gebracht oder ein Einkauf erledigt."},
                ...
                step25:{id:25,eng:'They say: "I bought the car for routes that are not accessible by public transport (last mile)."',de:'Die Person sagt in der Umfrage: "Ich habe mir das Auto für Strecken angeschafft, die nicht mit dem ÖPNV erreichbar sind (letzte Meile)."'},
            ...
            network_person6:{
                step29:{id:29,eng:"Similarly to our first person, the next participant travels from Potsdam to Berlin for work.",de:"Ähnlich wie unsere erste Person pendelt die nächste Person zwischen Potsdam und Berlin."},
                step30:{id:30,eng:"For transit, they use public transport. It takes them about 50 minutes to get there.",de:"Zum Pendeln nutzt sie vor allem öffentliche Verkehrsmittel. Für den Weg braucht sie etwa 50 Minuten."},
                step31:{id:31,eng:"Taking the car would take 15 minutes less. But traffic and the time to look for a parking station is not included, so it would probably not be that much faster.",de:"Es wäre etwa fünfzehn Minuten schneller, das Auto zu nehmen. Darin ist allerdings kein Berufsverkehr oder die Zeit für die Parkplatzsuche eingerechnet."},
                ...
                step33:{id:33,eng:'Even though they normally optimize their transit time, sometimes it does not work out: "Today I missed the connecting regional train." The walk between the two stations is too long. They needed to wait 20 minutes for the next train to come.',de:'Obwohl die Person sich Mühe gibt, ihre Umsteigezeit zu optimieren, klappt das nicht immer: "Heute habe ich den Anschlusszug verpasst. Der Fußweg zwischen den zwei Stationen war zu lang". Sie musste 20 Minuten auf den nächsten Regionalzug warten.'},
                ...
                step35:{id:35,eng:"They do not give the car any emotional value or memories. It only serves its purpose, but they do not need it specifically.",de:"Mit dem Auto verbindet sie keine Erinnerungen oder emotionale Werte. Es ist ein Gebrauchsgegenstand, auf den sie aber nicht angewiesen ist."},
            ...
            welcome_intro:{
                ...
                text3:{
                    ...
                    de: "Für die Visualisierung haben wir vier verschiedene Personen ausgewählt. Natürlich gibt es im Datensatz viel mehr Teilnehmer:innen. Wir haben sorgfältig überlegt, wen wir auswählen, und sind bei den Personen geblieben, die trotz des Lockdowns zumindest eine gewisse Mobilität hatten. Aus diesen Personen haben wir vier Personen mit unterschiedlichen Mobilitätsmustern ausgewählt - also mit diversen Hauptverkehrsmitteln, Zeiten, Wegen und Regelmäßigkeiten innerhalb der Mobilität. Auch wenn dies natürlich alles andere als repräsentativ ist, wollen wir dir damit ein vielfältiges Spektrum an Mobilitätsmustern zeigen."
                },
                text4:{
                    id:4,
                    ...
                    de: "Wir haben uns gefragt, wie wir eine aussagekräftige, reichhaltige Visualisierung der Daten erstellen und gleichzeitig die Privatsphäre der Teilnehmer:innen schützen können - und sind auf Mobilitätsnetzwerke gestoßen. Aber bevor wir tief in unsere Daten eintauchen, machen wir erst einmal einen Probelauf..."
                },
            ...
            outro_credits:{
                ...
                study:{
                    eng:"Special thanks also go to Christian Berkes and the MaaS L.a.b.s. team for the collaboration, your feedback and for providing data for this project.",
